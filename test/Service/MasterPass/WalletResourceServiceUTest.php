...
class WalletResourceServiceUTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var OAuth2Service
     */
    ...
    public function setUp()
    {
        ...
        $this->resourceService = new WalletResourceService($this->dummyOAuth2Service, $this->dummyHttpClient);
    }
